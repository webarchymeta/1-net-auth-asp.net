...
namespace Archymeta.Web.Security.OneNet.OAuth
{
    ...
    public class OneNetAuthenticationHandler : AuthenticationHandler<OneNetAuthenticationOptions>
    {
        ...
        public OneNetAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            var authorizationEndpoint = Options.Endpoints.AuthorizationEndpoint + "?client_id=" + Uri.EscapeDataString(Options.ClientId) +
                "&redirect_uri=" + Uri.EscapeDataString(redirectUri) + "&scope=" + Uri.EscapeDataString(scope) + "&state=" + Uri.EscapeDataString(state);
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            ...
            var context = new OneNetReturnEndpointContext(Context, ticket)
            {
